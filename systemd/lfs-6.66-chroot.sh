#!/bin/bash
echo ""
echo "### 6.69. Man-DB-2.7.2 (0.4 SBU - chrooted to lfs partition as 'root')"
echo "### ========================================================================="
...
time {
	...
	./configure --prefix=/usr                        \
            ...
            --with-grap=/usr/bin/grap																&> $LFS_LOG_FILE-configure.log
	...
	echo "*** Remove a reference to a non-existent user:"
