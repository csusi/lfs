#!/bin/bash
echo ""
echo "### 5.15. Ncurses-6.0 (0.6 SBU - running as 'lfs')"
echo "### ================================================"
echo "*** Note: This often comes up with four errors as (ignored) for the files"
echo "*** /tools/lib/libncursesw.so.5.9"
echo "*** /tools/lib/libpanelw.so.5.9"
echo "*** /tools/lib/libmenuw.so.5.9"
echo "*** /tools/lib/libformw.so.5.9"
echo "*** They do not appear to be critical and affect the build or final system."
...
time {
	...
	echo "Ensure gawk is found during configuration"
...
echo ""
echo "*** Note: Generates ignored errors. Appear to be harmless."
