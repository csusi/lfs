#!/bin/bash
echo ""
echo "### (BLFS) Expect-5.45 (0.2 SBU - chrooted to lfs partition as 'root')"
echo "### ====================================================================="
...
time {
	...
	./configure --prefix=/usr           \
            ...
            --with-tclinclude=/usr/include 		&> $LFS_LOG_FILE-configure.log
	...
	ln -svf expect5.45/libexpect5.45.so /usr/lib		&> $LFS_LOG_FILE-link-libexpect.log
}
