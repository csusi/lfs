#!/bin/bash
echo ""
echo "### (BLFS) libxml2-2.9.2  (0.5 SBU - chrooted to lfs partition as 'root')"
echo "### ====================================================================="
...
LFS_SECTION=9.4.13
LFS_SOURCE_FILE_PREFIX=libxml2
LFS_BUILD_DIRECTORY=    
...
time {
	...
	# Skipping for now.  see chapter about downloading tarbal for testsuite
