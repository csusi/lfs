#!/bin/bash
echo ""
echo "### 5.31. Tar-1.28 (0.4 SBU - running as 'lfs')"
echo "### ================================================"
echo "### Note: Make Check seems to take long"
...
#	### Note: Per book, 'make check' is not mandatory.  Because it takes a very
# ### long time to run, it is being commented out.
