#!/bin/bash
echo ""
echo "### (BLFS) Nettle-3.1.1  (0.3 SBU - chrooted to lfs partition as 'root')"
echo "### ================================================"
...
time {
	...
	chmod   -v   755 /usr/lib/lib{hogweed,nettle}.so 			&> $LFS_LOG_FILE-chmods.log
	install -v -m755 -d /usr/share/doc/nettle-3.1.1  			&> $LFS_LOG_FILE-install-doc.log
	install -v -m644 nettle.html /usr/share/doc/nettle-3.1.1	&> $LFS_LOG_FILE-install-htmldoc.log
}
