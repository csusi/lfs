#!/bin/bash
echo ""
echo "### 5.14. Check-0.10.0  (0.1 SBU - running as 'lfs')"
echo "### ================================================"
echo "### Make Check runs a LONG time.  The 0.1 SBU is a lie."
...
#	### Note: Because this is not mandatory and throws false 'errors' that are
#	### mostly just lines that have the word 'error' in them but not actual 
#	### errors, so it is being commented out.
